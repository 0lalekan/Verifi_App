            ...
            <div className="grid grid-cols-1 gap-8 max-w-lg mx-auto">
              <div className="bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-2xl border border-rose-200 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Scan Drug</h3>
                    <p className="text-rose-600 font-medium">Verify Medication Safety</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-8 leading-relaxed">Scan your medication barcode to verify authenticity, check interactions, and ensure it's safe for your health condition.</p>
                <Link to="/verify-drug">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-2xl border border-emerald-200 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Verify Drug Batch</h3>
                </div>
                <p className="text-gray-600 mb-8 leading-relaxed">Check and validate drug batch information, authenticity, and regulatory compliance to ensure patient safety.</p>
                <Link to="/verify-drug">
              ...
              <div className="bg-white/90 backdrop-blur-sm shadow-xl p-8 rounded-2xl border border-emerald-200 hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 group">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">Add new drug batches to the verification system with complete traceability and compliance tracking.</p>
